...
**ცოცხალი ვერსია:** https://kapo-toolkits.github.io/python-course/
...
არც დამოკიდებულება, არც build, არც CDN. ნებისმიერი `.html` ფაილი პირდაპირ
ბრაუზერში იხსნება — სერვერიდანაც და `file://`-იდანაც, ინტერნეტის გარეშეც.
